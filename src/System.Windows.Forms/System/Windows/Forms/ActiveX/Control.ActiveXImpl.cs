...
#pragma warning disable CA2301 // Do not call BinaryFormatter.Deserialize without first setting BinaryFormatter.Binder
                        deserialized = new BinaryFormatter { Binder = Application.BinaryFormatterBinder }.Deserialize(stream); // CodeQL[SM03722, SM04191] : BinaryFormatter is intended to be used as a fallback for unsupported types. Users must explicitly opt into this behavior
...
#pragma warning disable SYSLIB0011 // Type or member is obsolete
                        new BinaryFormatter { Binder = Application.BinaryFormatterBinder }.Serialize(stream, sourceValue);
