...
#pragma warning disable SYSLIB0011 // Type or member is obsolete
                    ...
                    }.Serialize(_resourceStream, _resources.Data);
...
#pragma warning disable CA2301 // Ensure BinaryFormatter.Binder is set before calling BinaryFormatter.Deserialize
                ...
                {
                    Binder = System.Windows.Forms.Application.BinaryFormatterBinder
                }.Deserialize(_resourceStream) as Hashtable; // CodeQL[SM03722, SM04191] : The operation is essential for the design experience when users are running their own designers they have created. This cannot be achieved without BinaryFormatter
