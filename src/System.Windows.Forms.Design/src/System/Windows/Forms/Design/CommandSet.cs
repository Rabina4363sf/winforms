...
#pragma warning disable SYSLIB0011 // Type or member is obsolete
                new BinaryFormatter { Binder = Application.BinaryFormatterBinder }.Serialize(stream, serializationData);
...
#pragma warning disable CA2300 // Do not use insecure deserializer BinaryFormatter
                        object serializationData = new BinaryFormatter { Binder = Application.BinaryFormatterBinder }.Deserialize(s); // CodeQL[SM03722, SM04191] : The operation is essential for the design experience when users are running their own designers they have created. This cannot be achieved without BinaryFormatter
